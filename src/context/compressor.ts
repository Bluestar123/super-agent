...
export function microcompact(messages: ModelMessage[]): {
  ...
  console.log("toolResultIndices", toolResultIndices.join(","));
...
// 上下文占用多少时在压缩， cc 87%， 这里写死的 300 字符
...
export async function summarize(
  ...
  // 从 用户提问开始，切分点一定不能落在 assistant 或 tool 消息上，
  // 否则保留的消息列表会以非 user 开头，
  ...
  // alignedIdx 最近的 user 压缩位置，之前的消息都要压缩掉
